      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/p/Municipalidad-de-Turrialba-100064617762560/?locale=es_LA" className="text-white hover:text-yellow-300" aria-label="Facebook" target="_blank">
              <FacebookIcon className="w-6 h-6" />
            </a>
            <a href="https://www.instagram.com/municipalturrialbacf/?hl=es" className="text-white hover:text-yellow-300" aria-label="Instagram" target="_blank">
              <InstagramIcon className="w-6 h-6" />
            </a>
            <a href="https://x.com/adm_turrialbacf?lang=es" className="text-white hover:text-yellow-300" aria-label="Twitter" target="_blank">
