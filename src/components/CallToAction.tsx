...
export function CallToAction() {
  return (
    <section className="py-12 bg-green-50 rounded-xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6">
              Eres un emprendedor local de Turrialba o Jiménez? Registra tu
              negocio y forma parte de nuestra comunidad.
            </p>
          ...
          <div className="md:text-right">
            <img
              src="https://images.unsplash.com/photo-1556155092-490a1ba16284?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80"
              alt="Persona emprendedora trabajando desde su laptop"
              title="Emprendedor trabajando"
              className="rounded-lg shadow-md inline-block max-w-full"
            />
          </div>
        </div>
      </div>
